	...
	<table class="table table-bordered table-hover">
		...
		<c:forEach var="item" items="${listRole }" varStatus="status">
			<tr class="item-list" data-id="${item.id }">
				...
				<td class="item-menu-group text-right"><a class="btn btn-sm btn-info eidt-Role" href="javascript:;"
					data-id="${item.id }">编辑</a> <a class="btn btn-sm btn-danger removeRole"
					href="javascript:;" data-id="${item.id }">删除</a></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
