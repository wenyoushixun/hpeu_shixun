...
<div class="addM add disappear">
	...
	<form class="form-inline"
		...
		<%-- <div class="form-group">
			<label for="exampleInputName2">昵 称：</label> <input type="text"
				class="form-control" id="exampleInputName2" value="${user.nickName}"
				name="nickName" maxlength="16" required>
		</div> --%>
		<div class="form-group">
			...
			$this.ajaxSubmit({
				beforeSubmit : function(data, $form) {
					...
					if ($.trim(nickName.val()) === "") {
						return showInputErrorTip(nickName, "请输入昵称");
					} else {
						hideInputErrorTip(nickName);
					} */
